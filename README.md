...
The full package is **34,447 Unicode code points (+66.7% versus the original)**
...
the active `AGENTS.md`, two guides, and move map total **34,447 Unicode code
points**. That is **+66.7% versus the original** because the package retains
the moved knowledge and the traceability needed to reconnect to it.

<p align="center">
  <a href="evidence/public_rc_v0_1/EVIDENCE.md">
    <img src="docs/images/public_v0_1/public-v0_1-result-metrics.png" alt="Compaction result showing 30.9% active-file reduction from 20,664 to 14,284 Unicode code points and a 34,447-code-point full package." width="1152">
  </a>
</p>
...
<a href="https://claude.ai/share/42e55369-9fa6-4c1c-aa5e-906496efd29e"><img width="1237" height="670" alt="スクリーンショット 2026-08-07 17 13 16" src="https://github.com/user-attachments/assets/17f5132b-6ae4-432b-9210-f8fe27bbc472" /></a>
